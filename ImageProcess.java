...
public class ImageProcess
{
	...
	{
		Color color;
		URL url = new URL("https://www.agric.wa.gov.au/sites/gateway/files/styles/original/public/Spot_type_net_blotch_lesion_closeup.jpg?itok=2EKkiHqk");
		...
		map.saveToFile(new File("Spot_Blotch.png"));
	}
